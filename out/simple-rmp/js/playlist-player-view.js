...
(function (exports) {
    ...
    function PlaylistPlayerView(settings) {
        ...
        this.prepareForNextVideo = function () {
            this.currentIndex = this.nextIndex;
            this.currentPlayerView.destroyCompleted = false;
            this.previewDismissed = false;
        ...
        this.transitionToNextVideo = function () {
            if (this.preloadedPlayerView) {
                ...
                this.currentPlayerView.remove();
                var readyForNextInterval = setInterval(function () {
                    if (this.currentPlayerView.destroyCompleted) {
                        clearInterval(readyForNextInterval);
                        this.prepareForNextVideo();
                    }
                }.bind(this), 250);
            } else {
                this.exit();
